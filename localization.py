...
"""
this class has all the functions and parameters to save the particles and the 
particle properties
"""
class ParticleFilter():
	...
	"""
	updates all the pixel considering the sensor readings
	"""
	def update(self):
		...
		# print('raw front distance: ' + str(center_sensor))
		...
		# print('modified front distance: ' + str(center_sensor))
		threshold = 0.1
		percent_change = 1.1
	...
	"""
	duplicate the deleted particles
	"""
	def resample(self):
		theta = [0, -0.1 , 0, 0.1, 0]
	...
	"""
	creating a convergence point if all the particles are relatively at the
	same location
	"""
	def converge(self):
	...
	"""
	odometry callback function to drive all the other functions
	"""
	...
	"""
	laser sensor callback function
	"""
	def laser_callback(self,data):
		self.laser = data
	"""
	sonar sensor callback function
	"""
	def sonar_callback(self,data):
		self.sonar = data
	"""
	the driving function which will drive the robot till convergence
	"""
	def goForward(self):
		safe_dist = 0.5
		self.velMsg = Twist()
...
"""
main iterative looping function
"""
def main():
	global root 
	root = tk.Tk()
