...
#########################################################################
PATH = "/home/stu11/s3/vvk3025/catkin_ws/src/prj/src/Floor_Map.png"
#########################################################################
...
def instantiate_parameters():
	...
	global local_done
	#root = tk.Tk()
	#mapr = Mapper(master=root,height=WIDTH,width=HEIGHT)
	sensor_active = " "
	wall_follow = False
	right_done = False
	left_done = False
...
def obstacle_detection():
	...
	if ((sonar.ranges[3] > stopping_dist) and (sonar.ranges[2] > stopping_dist) and (sonar.ranges[1] > stopping_dist) and ((sonar.ranges[4] > stopping_dist) and (sonar.ranges[5] > stopping_dist) and (sonar.ranges[4] > stopping_dist))) and sonar.ranges[7] >0.3 and sonar.ranges[0] >0.3 :
		hasObstacle = False
		sensor_active = " "
		wall_follow = False
		right_done = False
